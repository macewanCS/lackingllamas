        ...
        <div class="task-description-container">
            <div class="task-description-inner">
                ...
                <ul class="task-list">
                    ...
                    <li><div class="task-action"><label>Action </label><a href="{{url('/action', $task->action_id)}}"><span>A</span> {{\App\Action::findOrFail($task->action_id)->description}} </a></div></li>

                    <li><div class="task-lead"><label>Lead </label>{{\App\User::find($task->userId)->name}} </div></li>

                    <li><div class="task-group-lead"><label>Group Lead</label> {{\App\Group::find($task->group)->name}}</div></li>
                    ...
                    <li><div class="task-collab">
                            ...
                            @else
                                @foreach (explode(', ', $task->collaborators) as $colab)
                                    {{ $colab }}  <!-- TODO: Link to businessplan filtered by collabs -->
                                @endforeach
                            @endif
